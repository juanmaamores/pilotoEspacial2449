...
public class Button {
	...
	public void update() {
		...
		if(mouseIn && MouseInput.MLB && !clicked) {
	...
	public void draw(Graphics g) {
		...
		Text.drawText(g, text, new Vector2D(boundingBox.getX() + boundingBox.getWidth() /2, boundingBox.getY() + boundingBox.getHeight()), true, Color.BLACK, Assets.fontMed);
